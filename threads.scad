...
diameter = 10;   // Outer diameter, mm (e.g. M10)
pitch = 1.5;     // Thread pitch, mm (e.g. M10x1.5)
length = 20;     // Length of threaded part, mm

// Create the screw thread
metric_thread(diameter=diameter, pitch=pitch, length=length, internal=false);
